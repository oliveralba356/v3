$(function(){
    ...
    setInterval(function(){
        ...
        c.font = '50px Arial';
        c.textAlign = 'center';
        c.fillText('Combinar ',W/2,coord(0,250).y);
        c.fillText('color',W/2,coord(0,200).y);
        ...
        if(T > 70){
            ...
            c.strokeStyle = '#EEE';
            c.lineWidth = 2;
            c.fillText('INTENTAR',W/2,H/2);
            c.strokeText('INTENTAR',W/2,H/2);
            c.fillText('OTRA VEZ',W/2,H/2+50);
            c.strokeText('OTRA VEZ',W/2,H/2+50);
            if(clicked){
                score = 0;
                T = 0;
                TT = 0;
